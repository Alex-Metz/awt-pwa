...
const STATIC_CACHE_LIST = [
  ...
  "/awt-pwa/index.html",
  "/awt-pwa/static/js/2.d64b8b57.chunk.css",
  "/awt-pwa/static/js/2.943567e2.chunk.js",
  "/awt-pwa/static/js/main.2bd931e9.chunk.js",
  "/awt-pwa/static/css/runtime~main.a5205106.js",
  "/awt-pwa/precache-manifest.165830de3a1af117597f184cd1213271.js"
];
...
self.addEventListener("install", function(event) {
  event.waitUntil(
    caches
      ...
      .catch(error =>
        console.log("An Error occured while caching static resources!", error)
      )
  );
});
  ...
  event.waitUntil(
    caches
      ...
      .then(function(cacheNames) {
        return cacheNames.filter(cacheName => !cacheList.includes(cacheName)); // find old caches
      })
      ...
      .catch(error =>
        console.log("An Error occured while deleting old caches!", error)
      )
  );
});
